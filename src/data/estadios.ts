...
export const ESTADIOS: Estadio[] = [
  {
    ...
    sobre: "O Estádio Azteca é um verdadeiro coliseu do futebol moderno. Construído para a Copa de 1970, ele tem o apelido carinhoso de 'El Coloso de Santa Úrsula'. É o único estádio do mundo que pode se gabar de ter coroado Pelé (1970) e Diego Maradona (1986) como campeões mundiais. Curiosidade: o design do estádio permite que, independentemente da posição do sol, o gramado fique completely iluminado às 12h, horário clássico dos jogos históricos lá disputados.",
    momentos: [
      {
        id: "1",
